...
(function () {
  ...
  const I18N = {
    pt: {
      ...
      'footer.desc': `Safirion é a plataforma de trading profissional que combina velocidade, segurança e tecnologia de ponta.`,
      'footer.legal': `Legal`,
      'footer.terms': `Termos e Condições`, 'footer.aml': `Política AML e KYC`, 'footer.fees': `Taxas Gerais`, 'footer.execution': `Política de Execução`, 'footer.payment': `Política de Pagamento`, 'footer.cookies': `Política de Cookies`, 'footer.demo': `Contas Demo`, 'footer.risk': `Divulgação de Risco`, 'footer.withdrawal': `Política de Saque`, 'footer.margin': `Margin Trading`,
    ...
    es: {
      ...
      'footer.desc': `Safirion es la plataforma de trading profesional que combina velocidad, seguridad y tecnología de punta.`,
      'footer.legal': `Legal`,
      'footer.terms': `Términos y Condiciones`, 'footer.aml': `Política AML y KYC`, 'footer.fees': `Tarifas Generales`, 'footer.execution': `Política de Ejecución`, 'footer.payment': `Política de Pago`, 'footer.cookies': `Política de Cookies`, 'footer.demo': `Cuentas Demo`, 'footer.risk': `Divulgación de Riesgo`, 'footer.withdrawal': `Política de Retiro`, 'footer.margin': `Margin Trading`,
    ...
    en: {
      ...
      'footer.desc': `Safirion is the professional trading platform that combines speed, security and cutting-edge technology.`,
      'footer.legal': `Legal`,
      'footer.terms': `Terms and Conditions`, 'footer.aml': `AML and KYC Policy`, 'footer.fees': `General Fees`, 'footer.execution': `Order Execution Policy`, 'footer.payment': `Payment Policy`, 'footer.cookies': `Cookies Policy`, 'footer.demo': `Demo Account`, 'footer.risk': `Risk Disclosure`, 'footer.withdrawal': `Withdrawal Policy`, 'footer.margin': `Margin Trading`,
    ...
    fr: {
      ...
      'footer.desc': `Safirion est la plateforme de trading professionnelle qui allie vitesse, sécurité et technologie de pointe.`,
      'footer.legal': `Légal`,
      'footer.terms': `Conditions Générales`, 'footer.aml': `Politique AML et KYC`, 'footer.fees': `Frais Généraux`, 'footer.execution': `Politique d'Exécution`, 'footer.payment': `Politique de Paiement`, 'footer.cookies': `Politique de Cookies`, 'footer.demo': `Comptes Démo`, 'footer.risk': `Divulgation des Risques`, 'footer.withdrawal': `Politique de retrait`, 'footer.margin': `Margin Trading`,
